...
mc5_y = cal_abs_mc_V
mc5_x = sharp_metric_mc_V
kb1_y = cal_abs_KB_I
kb1_x = sharp_metric_kb_I
bp5_y = cal_abs_bp_V
bp5_x = sharp_metric_bp_V
en_y = cal_abs_en
en_x = sharp_metric_en

kbmc44_y = cal_abs_MC_IV_KB_IV
kbmc44_x = sharp_metric_mc_IV_kb_IV
kbmc51_y = cal_abs_MC_V_KB_I
kbmc51_x = sharp_metric_mc_V_kb_I

bpkb51_y = cal_abs_bp_V_kb_I
bpkb51_x = sharp_metric_bp_V_kb_I
kb1en_y = cal_abs_kb_I_en
kb1en_x = sharp_metric_kb_I_en
kb2en_y = cal_abs_kb_II_en
kb2en_x = sharp_metric_kb_II_en

fig, ax = plt.subplots()
# only these two lines are calibration curves
plt.plot(mc5_x, mc5_y, marker="o", linewidth=1, color="tomato", label="MC Dropout 0.5")
plt.plot(
    kb1_x, kb1_y, marker="o", linewidth=1, color="goldenrod", label="KB Dropout 0.1"
)
plt.plot(bp5_x, bp5_y, marker="o", linewidth=1, color="green", label="Bootstrap 0.5")
plt.plot(en_x, en_y, marker="o", linewidth=1, color="blueviolet", label="Ensembl")
plt.plot(
    kbmc44_x,
    kbmc44_y,
    marker="o",
...
plt.plot(
    kb2en_x, kb2en_y, marker="o", linewidth=1, color="dimgrey", label="KBEn 0.2 support"
)
